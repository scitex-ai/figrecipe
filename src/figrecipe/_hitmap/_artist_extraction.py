...
from ._resolve import as_mpl_figure
...
def _get_flat_axes(fig) -> List[Any]:
    ...
    RecordingFigure (from figrecipe.subplots) exposes fig.axes as a nested
    grid such as [[ax1], [ax2]] of RecordingAxes, whereas plain matplotlib
    uses a flat [ax1, ax2] of Axes. Resolving to the underlying matplotlib
    figure first normalises both: its fig.axes is always a flat list of Axes.
    """
