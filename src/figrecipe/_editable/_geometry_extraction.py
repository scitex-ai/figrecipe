#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: figrecipe/_editable/_geometry_extraction.py

"""
Geometry extraction utilities for the editable-figure schema (v0.3).

This module provides functions to extract shape geometry in axes-local pixel
coordinates from matplotlib artists for interactive hit-testing in the editor.
